...
lib.ssMetadata = [
		{name:"PR_Yoga_Slim_7i_Ultra_Aura_Edition_CM_GDN_728x90_atlas_1", frames: [[0,736,50,50],[0,0,728,90],[0,92,728,90],[0,184,728,90],[0,276,728,90],[0,368,728,90],[0,460,728,90],[0,552,728,90],[0,644,728,90]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_Yoga_Slim_7i_Ultra_Aura_Edition_CM_GDN_728x90_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRYogaSlim7iUltraAuraEditionCMGDN728x90 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(433).call(this.frame_433).wait(17));
	...
	this.timeline.addTween(cjs.Tween.get(this.btn_replay).wait(432).to({_off:false},0).wait(18));
	...
	this.timeline.addTween(cjs.Tween.get(this.mc_mui_ten_xoay).wait(420).to({_off:false},0).to({y:10.45},12).wait(18));
	...
	// Layer_8
	this.instance = new lib.Frame8();
	this.instance.setTransform(0,1);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(420).to({_off:false},0).wait(30));

	// Layer_7
	this.instance_1 = new lib.Frame7();
	this.instance_1.setTransform(0,1);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(360).to({_off:false},0).to({_off:true},60).wait(30));

	// Layer_6
	this.instance_2 = new lib.Frame6();
	this.instance_2.setTransform(0,1);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(300).to({_off:false},0).to({_off:true},60).wait(90));

	// Layer_5
	this.instance_3 = new lib.Frame5();
	this.instance_3.setTransform(0,1);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(240).to({_off:false},0).to({_off:true},60).wait(150));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(180).to({_off:false},0).to({_off:true},60).wait(210));

	// Layer_3
	this.instance_5 = new lib.Frame3();
	this.instance_5.setTransform(0,1);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(120).to({_off:false},0).to({_off:true},60).wait(270));

	// Layer_2
	this.instance_6 = new lib.Frame2();
	this.instance_6.setTransform(0,1);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(60).to({_off:false},0).to({_off:true},60).wait(330));

	// Layer_1
	this.instance_7 = new lib.Frame1();
	this.instance_7.setTransform(0,1);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({_off:true},60).wait(390));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(364,29.5,364,61.5);
// library properties:
lib.properties = {
	id: 'F98FEB1FFECD5D4DBA3AF43C87C737E8',
	width: 728,
	height: 90,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_Yoga_Slim_7i_Ultra_Aura_Edition_CM_GDN_728x90_atlas_1.png", id:"PR_Yoga_Slim_7i_Ultra_Aura_Edition_CM_GDN_728x90_atlas_1"}
	],
	preloads: []
};
...
an.compositions['F98FEB1FFECD5D4DBA3AF43C87C737E8'] = {
